...
remove = hyperparameters['removed']
X_train = remove_features(X_train, remove)
X_test = remove_features(X_test, remove)
...
# output to json
logger.log('Saving result to \"result/BQ3.json\"')
write_dict_to_json(filter_dict(histories, ['seed', 'Q3']), 'result/BQ3.json')
